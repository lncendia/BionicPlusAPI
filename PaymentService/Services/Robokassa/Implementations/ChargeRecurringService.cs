...
public class ChargeRecurringService
{
    ...
    public void PlanMonthlyCharge(string userId, string planId, string firstInvoiceId)
    {
        ...
        RecurringJob.AddOrUpdate<IRobokassaClient>($"{MonthlyPrefix}_{userId}", x => x.ChargeRecurrentPayment(firstInvoiceId, planId, userId), Cron.Monthly(day, hours, minutes));
    }
    ...
    public void PlanYearlyCharge(string userId, string planId, string firstInvoiceId)
    {
        ...
        RecurringJob.AddOrUpdate<IRobokassaClient>($"{YearlyPrefix}_{userId}", x => x.ChargeRecurrentPayment(firstInvoiceId, planId, userId), Cron.Yearly(day, hours, minutes));
    }
