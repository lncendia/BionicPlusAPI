...
namespace AuthService.Services.Implementations
{
    ...
    internal static class Rfc6238AuthenticationService
    {
        ...
        private static readonly TimeSpan _timestep = TimeSpan.FromMinutes(5);
        private static readonly Encoding _encoding = new UTF8Encoding(false, true);

        private static int ComputeTotp(HashAlgorithm hashAlgorithm, ulong timestepNumber, string modifier, int numberOfDigits = 4)
        {
