...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection ConfigureReverseProxyConfig(this IServiceCollection services, IConfigurationSection reverseProxySection)
    {
        services.Configure<ReverseProxyConfig>(reverseProxySection);
        return services;
    }
}